...
def save_gt_dict(sequence,gt_obj_dict_dir,dataset_path):
    ...
    for i in range(len(timestamps_masks)):
        ...
        honey_grid_path = '/Users/cainan/Desktop/active_perception/event_depth_esti/code/stppp_and_output/x-student-events/ECCV_plot/output/honey_grid/honey_grid_radius_40.npy'
        mask = np.load(honey_grid_path)
        if i % 50 == 1:
        ...
        for object_id in object_ids:
            ...
            selected_pixels = depth[(mask == object_id)]
            count_d_equals_0 = (selected_pixels == 0).sum()
            if count_d_equals_0 > len(selected_pixels) / 2:
                # print("More than half of selected_pixels are equal to 0.",object_id)
                object_ids = np.delete(object_ids, np.where(object_ids == object_id))
...
def save_gt_dicts(save_dir,dataset_path,sequences):
    ...
    gt_obj_dict_dir = f"{save_dir}/{current_date}_rel_gt_obj_dict_{dataset_name}_honey"
...
if __name__ == '__main__':
    ...
    if dataset_name == 'sfm':
        ...
        # sequences = ['scene_03_02_000000','scene_03_02_000002',
        #             'scene_03_02_000003','scene_03_03_000000','scene_03_03_000002']
